...
const LiabilityWaiverCTA = () => (
  <div className="w-full flex flex-col items-center py-8 bg-secondary/40">
    <Button
      asChild
      size="lg"
      className="text-base px-8 py-4 font-semibold rounded-lg bg-primary hover:bg-primary/90 text-primary-foreground shadow-lg transition-colors duration-200 flex items-center gap-2 font-sans"
    >
    ...
    <p className="mt-4 text-sm text-muted-foreground italic text-center max-w-xs mx-auto px-4 font-sans">
